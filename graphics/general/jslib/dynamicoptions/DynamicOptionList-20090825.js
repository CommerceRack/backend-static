...
function DOL_child(obj) {
  ...
  if(listIndex == undefined)   //  Ghetto booty hack added by JT to fix IE's issue with not seeing when Select 1 is created dynamically
  	listIndex = 0;
//  alert("DOL_child listIndex = "+listIndex);
