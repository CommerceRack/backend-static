...
//Push the new div into the add to cart form as a new child.
	$("addToCartFrm").appendChild(formFieldDiv);   /// NOTE the form ID on this should probably be auto-generated from the element ID.
