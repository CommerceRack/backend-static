...
//If the option IS required (not set to optional) AND the option value is blank, record an error
			...
			if(MYADD2CART_pogs[i]['optional'] != 1 && pogValue == "")	{
				valid = false;
				$('pogErrors').innerHTML +=	 "The choice for '"+MYADD2CART_pogs[i]['prompt']+"' is required. Please make a selection <span class='zhint' style='font-weight:normal'>( id: "+pogid+")</span><br>";
				}
