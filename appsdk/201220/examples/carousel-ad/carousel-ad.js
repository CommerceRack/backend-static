...
//				myControl.model.addDispatchToQ({"_cmd":"buyerAddressList","_tag": tagObj},Q);
	...
	callbacks : {
		init : {
			onSuccess : function()	{
				myControl.model.fetchNLoadTemplates('templates.html',['productChildrenTemplate','cartTemplate','productListTemplateCart','productTemplate','prodReviewSummaryTemplate','prodReviewsTemplate','imageViewerTemplate']);
