...
//myControl.data is passed in because something needs to be, but this is generated prior to any ajax calls occuring (possibly) so the cart can't be passed in.
...
//				myControl.util.dump("phone number is: "+zGlobals.checkoutSettings.chkout_phone);
...
//expiration is less of a concern
						case 'CREDIT':
							o = "<li><label for='payment-cc'>Credit Card #<\/label><input type='text' size='16' name='payment.cc' id='payment-cc' class='zform_textbox creditCard' value='";
