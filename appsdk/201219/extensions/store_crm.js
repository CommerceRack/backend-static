...
//adds a lineitem template for each stid in stuff
				for(i = 0; i < L; i +=1)	{
					...
					pid = stid.split(':')[0]
					$parent.append(myControl.renderFunctions.transmogrify({
"id":'order_'+orderID+'_stid_'+stid,
"pid":pid,
"stid":stid},'orderProductLineItemTemplate',myControl.data[tagObj.datapointer].order.stuff[i]));
