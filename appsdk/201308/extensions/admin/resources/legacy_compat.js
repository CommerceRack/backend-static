...
var winobj; // needs to be global for window.opener to work.
function openPopupWindow(url)	{
	// used for ebay category chooser popup 
	// note: must be assigned to a var or child will lose it's ability to access window.parent
	winobj = window.open(url,'legacyPopup','height=500,width=500,scrollbars=1,dependent=1');
	}
