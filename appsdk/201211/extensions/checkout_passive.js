...
// even in passive, this is needed. not sure why.
...
//formerly getShippingRatesWithUpdate
		...
		cartPaypalSetExpressCheckout : {
			...
			dispatch : function(callback)	{
				myControl.model.addDispatchToQ({"_cmd":"buyerAddressList","cancelURL":myControl.vars.secureURL+"cart.cgis","returnURL":myControl.vars.secureURL+"checkout.cgis"},'immutable');
				}
			}, //cartPaypalSetExpressCheckout	
