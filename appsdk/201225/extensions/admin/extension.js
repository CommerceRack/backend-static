...
myControl.model.fetchNLoadTemplates('/biz/ajax/zmvc/201225/extensions/admin/templates.html',theseTemplates);
...
//	myControl.util.dump(" -> aattribute value = "+myControl.data['appProductGet|'+pid]['%attribs'][attribute]);
	...
	myControl.util.dump(" -> NON product attribute (no pid specified). 2012-08-14d");
