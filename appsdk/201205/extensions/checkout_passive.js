...
// NOTE - I think this is what the data source should be. need to chat with B.???
// also, if this is changed, the view needs to be updated.
// data-bind='var: cart(@methods); format:shipMethodsAsRadioButtons; extension:convertSessionToOrder;' instead of
//  data-bind='var: cart(@shipmethods); format:shipMethodsAsRadioButtons; extension:convertSessionToOrder;'
//				myControl.renderFunctions.translateTemplate(myControl.data.getShippingRates,'shipMethodsContainer');
...
//				myControl.util.dump("BEGIN myControl.ext.convertSessionToOrder.utilities.addressFieldUpdated");
				if(myControl.ext.convertSessionToOrder.utilities.taxShouldGetRecalculated())	{
					...
					myControl.ext.convertSessionToOrder.calls.getCartContents.init();
					}
				}, //addressFieldUpdated
