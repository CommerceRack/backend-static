...
app.rq.push(['extension',0,'orderCreate',app.vars.baseURL+'extensions/checkout/extension.js','startCheckout']);
app.rq.push(['extension',0,'store_cart',app.vars.baseURL+'extensions/store_cart.js']); //some shared render formats


app.rq.push(['script',0,app.vars.httpsURL+'jsonapi/config.js']); //The config.js is dynamically generated. since this is 1PC, always load securely.
